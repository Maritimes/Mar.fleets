...
#' information for the tunas fleet:
#' \itemize{
...
#' @examples \dontrun{
#' tunas <- fleet_tunas(data.dir = "C:/myData")
#'                           }
#' @family fleets
...
#' \itemize{
#'   \item \code{marfSpp} = c(252, 253, 254, 255, 256, 257, 259)
#'   \item \code{gearCode} = 51
#'   \item \code{mdCode} = c(5)
#' }
#' @export
fleet_tunas <- function(...){
  warning("This analytic has not been thoroughly reviewed.  Use at your own risk.")

  marfSpp= c(252, 253, 254, 255, 256, 257, 259)
  gearCode = 51
  mdCode = 5
