...
for (y in 1:length(yr)){
  Haddock_m_5Z[[paste0("haddock_",yr[y])]]<- get_haddock(year = yr[y], type = "mobile", area = "5Zjm")
  # Haddock_f_5Z[[paste0("haddock_",yr[y])]]<- get_haddock(year = yr[y], type = "fixed", area = "5Zjm")
  # Haddock_m_4X[[paste0("haddock_",yr[y])]]<- get_haddock(year = yr[y], type = "mobile", area = "4X5Y")
}
Haddock_m_5Z$haddock_2015$catch_T3563.058
Haddock_m_5Z$haddock_2016$catch_T2780.592
Haddock_m_5Z$haddock_2017$catch_T1519.366
Haddock_m_5Z$haddock_2018$catch_T498.6487
