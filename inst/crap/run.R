...
all_obs1$OBS_TRIPS <- all_obs1$OBS_TRIPS[all_obs1$OBS_TRIPS$TRIP_ID_OBS %in% trips$MAP_OBS_MARFIS_TRIPS$TRIP_ID_OBS,]
all_obs1$OBS_SETS <- all_obs1$OBS_SETS[all_obs1$OBS_SETS$FISHSET_ID %in% sets$MAP_OBS_MARFIS_SETS$FISHSET_ID,]
...
checkO2<-Mar.utils::prepare_shape_fields(merge(all_obs1$OBS_SETS , all_obs1$OBS_TRIPS, by.x="TRIP_ID", by.y="TRIP_ID_OBS"))
