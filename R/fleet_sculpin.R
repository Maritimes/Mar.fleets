...
#' \itemize{
#'   \item \code{Licence Type, Subtype, Gear and Species Information (if applicable)} \code{Mar.fleets::licCore[Mar.fleets::licCore$FLEET=="SCULPIN",]}
#'   \item \code{Licence Areas (if applicable)} \code{Mar.fleets::licAreas[Mar.fleets::licAreas$FLEET=="SCULPIN",]}
#'
...
fleet_sculpin <- function(useLocal = NULL, ...){
  ...
  data = fleet_(fleet = "SCULPIN", marfSpp = c(181), isdbSpp = c(300), area = "ALL", tripcd_id = NULL, useLocal = useLocal,...)
  return(data)
}
