...
#' \itemize{
#'   \item \code{Licence Type, Subtype, Gear and Species Information (if applicable)} \code{Mar.fleets::licCore[Mar.fleets::licCore$FLEET=="CUCUMBER",]}
#'   \item \code{Licence Areas (if applicable)} \code{Mar.fleets::licAreas[Mar.fleets::licAreas$FLEET=="CUCUMBER",]}
#'
...
fleet_cucumber <- function(useLocal = NULL, ...){
  ...
  data = fleet_(fleet = "CUCUMBER", marfSpp = c(619), isdbSpp = c(6600,6611), area = "ALL", tripcd_id = c(6600), useLocal = useLocal,...)
  return(data)
}
