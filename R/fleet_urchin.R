...
#' \itemize{
#'   \item \code{Licence Type, Subtype, Gear and Species Information (if applicable)} \code{Mar.fleets::licCore[Mar.fleets::licCore$FLEET=="URCHIN",]}
#'   \item \code{Licence Areas (if applicable)} \code{Mar.fleets::licAreas[Mar.fleets::licAreas$FLEET=="URCHIN",]}
#'
...
fleet_urchin <- function(useLocal = NULL, ...){
  ...
  data = fleet_(fleet = "URCHIN", marfSpp = c(650), isdbSpp = c(6400), area = "ALL", tripcd_id = c(6400), useLocal = useLocal,...)
  return(data)
}
