...
#' \itemize{
#'   \item \code{Licence Type, Subtype, Gear and Species Information (if applicable)} \code{Mar.fleets::licCore[Mar.fleets::licCore$FLEET=="ROCKCRAB",]}
#'   \item \code{Licence Areas (if applicable)} \code{Mar.fleets::licAreas[Mar.fleets::licAreas$FLEET=="ROCKCRAB",]}
#'
...
fleet_rockCrab <- function(useLocal = NULL, ...){
  ...
  data = fleet_(fleet = "ROCKCRAB", marfSpp = c(704,742), isdbSpp = c(2513), area = "ALL", tripcd_id = c(2509), useLocal = useLocal,...)
  return(data)
}
