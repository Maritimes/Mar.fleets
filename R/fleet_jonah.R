...
#' \itemize{
#'   \item \code{Licence Type, Subtype, Gear and Species Information (if applicable)} \code{Mar.fleets::licCore[Mar.fleets::licCore$FLEET=="JONAH",]}
#'   \item \code{Licence Areas (if applicable)} \code{Mar.fleets::licAreas[Mar.fleets::licAreas$FLEET=="JONAH",]}
#'
...
fleet_jonah <- function(useLocal = NULL, ...){
  ...
  data = fleet_(fleet = "JONAH", marfSpp = c(703), isdbSpp = c(2511), area = "ALL", tripcd_id = c(2509), useLocal = useLocal,...)
  return(data)
}
