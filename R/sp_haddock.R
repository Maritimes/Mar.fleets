...
#' @examples Haddock_5ZJM_m <- sp_haddock(data.dir = "C:/myData", year = 2018, type = "MOBILE", area = "5ZJM")
#' Haddock_4X5Y_f <- sp_haddock(data.dir = "C:/myData", year = 2018, type = "FIXED", area = "4X5Y")
#' @family species
#' @return
