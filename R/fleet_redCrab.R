...
#' \itemize{
#'   \item \code{Licence Type, Subtype, Gear and Species Information (if applicable)} \code{Mar.fleets::licCore[Mar.fleets::licCore$FLEET=="REDCRAB",]}
#'   \item \code{Licence Areas (if applicable)} \code{Mar.fleets::licAreas[Mar.fleets::licAreas$FLEET=="REDCRAB",]}
#'
...
fleet_redCrab <- function(useLocal = NULL, ...){
  ...
  data = fleet_(fleet = "REDCRAB", marfSpp = c(706,742), isdbSpp = c(2532), area = "ALL", tripcd_id = c(2509), useLocal = useLocal,...)
  return(data)
}
