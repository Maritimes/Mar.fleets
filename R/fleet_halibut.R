...
#' \itemize{
#'   \item \code{Licence Type, Subtype, Gear and Species Information (if applicable)} \code{Mar.fleets::licCore[Mar.fleets::licCore$FLEET=="HALIBUT",]}
#'   \item \code{Licence Areas (if applicable)} \code{Mar.fleets::licAreas[Mar.fleets::licAreas$FLEET=="HALIBUT",]}
#'
...
fleet_halibut <- function(useLocal = NULL, ...){
  ...
  data = fleet_(fleet = "HALIBUT", marfSpp = 130, isdbSpp = 30, area = "ALL", tripcd_id = c(30,7057,7058), useLocal = useLocal,...)
  return(data)
}
